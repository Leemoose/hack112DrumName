...
path = '/Users/maqianou/Documents/GitHub/hack112DrumName/audio/WALK_THE_MOON_Work_This_Body.wav'
...
if __name__ == '__main__':
    import sys
    f = '/Users/maqianou/Documents/GitHub/hack112DrumName/audio/WALK_THE_MOON_Work_This_Body.wav'
    bpm = get_file_bpm(f)
print("{:6s} {:s}".format("{:2f}".format(bpm), f))